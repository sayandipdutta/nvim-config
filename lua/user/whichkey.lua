...
local mappings = {
  ...
  f = {
    ...
    f = {
      "<cmd>lua require('telescope.builtin').find_files( { cwd = vim.fn.expand('%:p:h') }, require('telescope.themes').get_dropdown{previewer = false})<cr>",
      "Find files",
    },
  ...
  l = {
    ...
    D = { "<cmd>Telescope diagnostic<cr>", "TeleDiagnostics" },
    w = {
